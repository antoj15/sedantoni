...
class GithubCli(object):
    ...
    def verify_device(self,code,resp):
        ...
        payload = {'authenticity_token':authenticity_token,'opt':int(code)}
        resp = self.session.post(verifyurl,data=payload)
...
#cli = GithubCli('obysoftt@gmail.com','Obysoft2001@*','Obysoftt')
